...
const SprintSpreadsheet = () => {
  ...
  const [tasks, setTasks] = useState(() => {
    ...
    { id: 6, sprint: 1, week: 2, day: '1-2', task: 'Core Testing (Unit Tests)', priority: 'MUST HAVE', status: 'pending', assignee: '', notes: 'Test supervisor, calendar, health agents. 60% coverage goal' },
    { id: 7, sprint: 1, week: 2, day: '3-4', task: 'Integration Testing', priority: 'MUST HAVE', status: 'pending', assignee: '', notes: 'End-to-end flows, real Google Calendar, error scenarios' },
    { id: 8, sprint: 1, week: 2, day: '5', task: 'Documentation Update', priority: 'MUST HAVE', status: 'pending', assignee: '', notes: 'Update SETUP.md, create QUICK_START.md, TROUBLESHOOTING.md' },
